...
const profile = require("../model/profileModel.js")(mongoose);
const config = require("../model/configModel.js")(mongoose);
const team = require("../model/teamModel.js")(mongoose);
const player = require("../model/playerModel.js")(mongoose);
